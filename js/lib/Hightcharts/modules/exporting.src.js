...
var HC = Highcharts,
	...
	extend(defaultOptions.lang, {
		...
		downloadSVG: 'Download SVG imagem gráfica vetorial',
...
defaultOptions.exporting = {
	...
	//url: 'http://export.highcharts.com/',
        //url:'http://www2.ms.sebrae.com.br/desenv/intranet/sga/lib/Highcharts-2.2.5/exporting-server/index.php',
        //url : 'http://www.sga.ms.sebrae.com.br/lib/Highcharts-2.2.5/exporting-server/index.php',
        url: endereco_base+'lib/Highcharts-2.2.5/exporting-server/index.php',
	width: 800,
	buttons: {
		exportButton: {
			//enabled: true,
...
extend(Chart.prototype, {
	...
	exportChart: function (options, chartOptions) {
		...
		// add the values
		each(['filename', 'type', 'width', 'svg', 'name_arquivo', 'dir_upload'], function (name) {
			createElement('input', {
				type: HIDDEN,
				name: name,
				value: {
					...
					width: options.width,
					svg: svg,
                                        name_arquivo : $("#form_name_arquivo").val(),
                                        dir_upload : $("#form_dir_upload").val()
				}[name]
			}, null, form);
		});
